# Revista Adolfo Sourdeaux

Revista digital de Ingeniero Adolfo Sourdeaux (Malvinas Argentinas, Buenos Aires). Se publica en cualquier hosting y se reparte por WhatsApp, email y redes.

El barrio también se conoce como Km 30. Esta edición cubre el casco de la estación (Rosario, Derqui, Juan Madera) y alrededores.
...
2. Subí **todo el contenido de esta carpeta** a `public_html` (o a una subcarpeta, por ejemplo `public_html/revista-adolfo-sourdeaux`).
