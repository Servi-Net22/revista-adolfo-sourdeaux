(function () {
  ...
  function renderComercios() {
    ...
    root.innerHTML =
      '<div class="wrap page-hero"><p class="kicker">Guía del barrio</p><h1>Comercios de ' +
      (C.barrio || C.lugar) +
      "</h1><p>Almacenes, oficios, salud y gastronomía para comprar cerca. Cada ficha viaja en la edición que se comparte por WhatsApp y email.</p></div>" +
  ...
  function renderActualidad() {
    ...
    root.innerHTML =
      '<div class="wrap page-hero"><p class="kicker">Actualidad</p><h1>Lo que pasa en ' +
      (C.barrio || C.lugar) +
